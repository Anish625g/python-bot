...
BOT_TOKEN = "5710284858:6176061184:AAHB-O1bghYAmDdDcZNGviE-XBGRwuye6hU"
PAYMENT_CHANNEL = "@Share_And_Eran" #add payment channel here including the '@' sign
OWNER_ID = 1993716431 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@Daily_Profit_King"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
